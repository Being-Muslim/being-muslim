...
<section class="relative flex min-h-screen flex-col justify-end overflow-hidden">
	...
	<div class="relative z-10 mx-auto w-full max-w-[1400px] px-6 lg:px-10 pb-10">
		<div class="bm-grid-explore" style="background: rgba(227,218,204,0.92); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border-radius: 16px; padding: 28px 20px;">
			...
			<!-- Card: Learn -->
			<a href="/c/learn" class="bm-card-hover" style="background: rgba(240,238,230,0.9); border-radius: 12px; padding: 28px; display: flex; flex-direction: column; justify-content: space-between; text-decoration: none;">
				<div>
			...
			<!-- Card: Convert -->
			<a href="/c/convert" class="bm-card-hover" style="background: rgba(240,238,230,0.9); border-radius: 12px; padding: 28px; display: flex; flex-direction: column; justify-content: space-between; text-decoration: none;">
				<div>
			...
			<!-- Card: Buy -->
			<a href="/c/shop" class="bm-card-hover" style="background: rgba(240,238,230,0.9); border-radius: 12px; padding: 28px; display: flex; flex-direction: column; justify-content: space-between; text-decoration: none;">
				<div>
