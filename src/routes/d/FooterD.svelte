	...
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		<div class="bm-grid-footer">
			...
			<div>
				...
				{#each [
					{ label: 'Articles', href: '/d/learn' },
					{ label: 'Courses', href: '/d/learn' },
					{ label: 'Resources', href: '/d/learn' }
				] as link}
			...
			<div>
				...
				{#each [
					{ label: 'The Book', href: '/d/shop' },
					{ label: 'Boxed Set', href: '/d/shop' },
					{ label: 'Prayer Cards', href: '/d/shop' },
					{ label: 'eBook', href: '/d/shop' }
				] as link}
					<a href={link.href} class="bm-footer-link">{link.label}</a>
				{/each}
			</div>
			...
			<div>
				...
				{#each [
					{ label: 'Donate', href: '/d/support' },
					{ label: 'Request Donation', href: '/d/support' },
					{ label: 'Volunteer', href: '/d/support' }
				] as link}
					<a href={link.href} class="bm-footer-link">{link.label}</a>
				{/each}
			</div>
		...
		<div style="border-top: 1px solid rgba(255,255,255,0.08); padding: 20px 0; display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 12px;">
			...
			<div style="display: flex; gap: 24px;">
				...
				<a href="/d/contact" class="bm-footer-link" style="font-size: 12px; color: rgba(255,255,255,0.3);">Contact</a>
			</div>
		</div>
	</div>
</footer>
