<footer style="background: #2C3E2C; padding: 64px 0 0;">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		<div class="bm-grid-footer">
			<!-- Brand -->
			<div>
				<a href="/d" style="display: flex; align-items: center; gap: 10px; text-decoration: none; margin-bottom: 16px;">
					...
					<span style="font-family: 'Newsreader', serif; font-size: 18px; color: #fff;">Being Muslim</span>
				</a>
				<p style="font-family: 'Albert Sans', sans-serif; font-size: 13px; color: rgba(255,255,255,0.5); line-height: 1.6; max-width: 260px; margin-bottom: 20px;">
					Guiding converts and seekers on a meaningful Islamic journey through education, community, and heartfelt support.
				</p>
				<!-- Social Icons -->
			...
			<!-- Learn -->
			<div>
				<h4 style="font-family: 'Albert Sans', sans-serif; font-size: 12px; font-weight: 600; color: #fff; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 16px;">Learn</h4>
				{#each [
					{ label: 'Articles', href: '/d' },
					{ label: 'Courses', href: '/d' },
					{ label: 'Resources', href: '/d' }
				] as link}
			...
			<!-- Shop -->
			<div>
				<h4 style="font-family: 'Albert Sans', sans-serif; font-size: 12px; font-weight: 600; color: #fff; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 16px;">Shop</h4>
				{#each [
					{ label: 'The Book', href: '/d' },
					{ label: 'Boxed Set', href: '/d' },
					{ label: 'Prayer Cards', href: '/d' },
					{ label: 'eBook', href: '/d' }
				] as link}
					<a href={link.href} class="bm-footer-link">{link.label}</a>
				{/each}
			...
			<!-- Support -->
			<div>
				<h4 style="font-family: 'Albert Sans', sans-serif; font-size: 12px; font-weight: 600; color: #fff; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 16px;">Support</h4>
				{#each [
					{ label: 'Donate', href: '/d' },
					{ label: 'Request Donation', href: '/d' },
					{ label: 'Volunteer', href: '/d' }
				] as link}
					<a href={link.href} class="bm-footer-link">{link.label}</a>
				{/each}
			</div>
			...
			<!-- Company -->
			<div>
				<h4 style="font-family: 'Albert Sans', sans-serif; font-size: 12px; font-weight: 600; color: #fff; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 16px;">Company</h4>
				{#each [
					{ label: 'About Us', href: '/d' },
					{ label: 'Contact', href: '/d' },
					{ label: 'Convert', href: '/d' },
					{ label: 'Privacy Policy', href: '/d' }
				] as link}
					<a href={link.href} class="bm-footer-link">{link.label}</a>
				{/each}
			</div>
		...
		<div style="border-top: 1px solid rgba(255,255,255,0.08); padding: 20px 0; display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 12px;">
			<p style="font-family: 'Albert Sans', sans-serif; font-size: 12px; color: rgba(255,255,255,0.3);">&copy; 2026 The Being Muslim Project. All rights reserved.</p>
			<div style="display: flex; gap: 24px;">
				<a href="/d" class="bm-footer-link" style="font-size: 12px; color: rgba(255,255,255,0.3);">Privacy</a>
				<a href="/d" class="bm-footer-link" style="font-size: 12px; color: rgba(255,255,255,0.3);">Terms</a>
				<a href="/d" class="bm-footer-link" style="font-size: 12px; color: rgba(255,255,255,0.3);">Contact</a>
			</div>
		</div>
	</div>
</footer>
