...
<section style="background: #fff; padding: 64px 0;">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		...
		<h1 style="font-family: 'DM Serif Display', serif; font-size: 28px; font-weight: 400; color: #2a2018; margin: 0 0 48px;">FAQ Option 1: CTA Card</h1>
		...
		<div style="display: grid; grid-template-columns: 1fr 380px; gap: 48px; align-items: start;">
			...
			<div style="position: sticky; top: 100px;">
				<div style="background: #e9e3da; border-radius: 12px; padding: 32px;">
					<h3 style="font-family: 'DM Serif Display', serif; font-size: 22px; font-weight: 400; color: #2a2018; margin: 0 0 12px; line-height: 1.25;">
