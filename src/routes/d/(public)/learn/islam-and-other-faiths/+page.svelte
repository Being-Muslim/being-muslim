...
<section style="background-color: #2a2018;" class="pt-[72px]">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10 py-16 sm:py-24">
		<div class="mx-auto max-w-3xl">
			...
			<h1
				style="font-family: 'DM Serif Display', serif; color: #f0ebe3;"
...
<section style="background-color: #f0ebe3;">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10 py-16">
		<article class="mx-auto max-w-3xl" style="font-family: 'DM Sans', sans-serif;">
			<h2 style="font-family: 'DM Serif Display', serif; color: #2a2018;" class="text-2xl mb-4">
				A Shared Heritage
			</h2>
			...
			<h2 style="font-family: 'DM Serif Display', serif; color: #2a2018;" class="text-2xl mb-4 mt-10">
