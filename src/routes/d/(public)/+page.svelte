	...
	<div class="relative z-10 mx-auto w-full max-w-[1400px] px-6 pt-32 pb-12 lg:px-10">
		<div class="max-w-[680px]">
			<h1 class="font-display text-[44px] font-bold leading-[1.05] tracking-[-0.02em] text-white sm:text-[56px] lg:text-[68px]">
				...
				<span class="italic font-normal text-amber-200/90">Islamic journey</span>
			</h1>
	...
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		<div style="background: #e3dacc; border-radius: 16px; padding: 48px; display: grid; grid-template-columns: 1fr 280px 280px; gap: 20px; align-items: stretch;">
			...
			<div style="display: flex; flex-direction: column; justify-content: space-between; padding-right: 24px;">
				<div>
					<h2 style="font-family: 'DM Serif Display', serif; font-size: 36px; font-weight: 400; color: #2a2018; margin: 0 0 16px; line-height: 1.15;">Explore your path</h2>
			...
			<!-- Card: Learn -->
			<a href="/d/learn" class="bm-card-hover" style="background: #f0eee6; border-radius: 12px; padding: 28px; display: flex; flex-direction: column; justify-content: space-between; text-decoration: none;">
				<div>
					...
					<p style="font-family: 'DM Serif Display', serif; font-size: 24px; font-weight: 400; color: #2a2018; margin: 0; line-height: 1.2;">Courses &amp; Resources</p>
				</div>
			...
			<!-- Card: Convert -->
			<a href="/d/convert" class="bm-card-hover" style="background: #f0eee6; border-radius: 12px; padding: 28px; display: flex; flex-direction: column; justify-content: space-between; text-decoration: none;">
				<div>
					...
					<p style="font-family: 'DM Serif Display', serif; font-size: 24px; font-weight: 400; color: #2a2018; margin: 0; line-height: 1.2;">Start Your Journey</p>
				</div>
				<div style="margin-top: 24px; text-align: right;">
					<ArrowRight class="h-5 w-5" style="color: #2a2018;" />
				</div>
...
<section style="background: #faf9f5; padding: 64px 0;">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		<div style="display: flex; justify-content: space-between; align-items: end; margin-bottom: 32px;">
			<h2 style="font-family: 'DM Serif Display', serif; font-size: clamp(26px, 3.8vw, 38px); line-height: 1.15; color: #2a2018; font-weight: 400; margin: 0;">
				Latest Resources
			</h2>
		...
		<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;">
			{#each [
				...
				<a href={article.href} style="text-decoration: none; display: block;" class="bm-title-underline-parent">
					...
					<h3 class="bm-title-underline" style="font-family: 'DM Serif Display', serif; font-size: 18px; font-weight: 400; color: #2a2018; margin: 0 0 8px; line-height: 1.3;">{article.title}</h3>
...
<section style="background: #faf9f5; padding: 64px 0;">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		<h2 style="font-family: 'DM Serif Display', serif; font-size: clamp(26px, 3.8vw, 38px); line-height: 1.15; color: #2a2018; font-weight: 400; margin: 0 0 32px; text-align: center;">
			Everything you need to begin
		</h2>

		<div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px;">
			{#each [
				{ title: 'Being Muslim: A Practical Guide', price: '$24.99', badge: 'Bestseller', img: 'https://www.beingmuslim.org/wp-content/uploads/2021/08/being-muslim-book.jpeg', href: '/d/shop/book' },
				{ title: 'The Complete Boxed Set', price: '$84.99', badge: 'Most Popular', img: 'https://www.beingmuslim.org/wp-content/uploads/2021/08/the-boxed-set-900x1200.jpeg', href: '/d/shop/boxed-set' },
				{ title: 'Prayer Reference Cards', price: '$14.99', badge: '', img: 'https://www.beingmuslim.org/wp-content/uploads/2021/08/the-prayer-card-900x610.jpeg', href: '/d/shop/prayer-cards' },
				{ title: 'Digital Edition (eBook)', price: '$12.99', badge: '', img: 'https://www.beingmuslim.org/wp-content/uploads/2021/08/BM-E-Book-900x1200.png', href: '/d/shop/ebook' }
			] as product}
				<a href={product.href} style="text-decoration: none; display: block;" class="bm-title-underline-parent group">
					...
					<h3 class="bm-title-underline" style="font-family: 'DM Serif Display', serif; font-size: 16px; font-weight: 400; color: #2a2018; margin: 0 0 6px; line-height: 1.3;">{product.title}</h3>
	...
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		...
		<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;">
			{#each [
				...
				<a href="/d/learn" style="text-decoration: none; display: block;" class="bm-title-underline-parent">
		...
		<div style="background: #2a2018; border-radius: 16px; overflow: hidden;">
			<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0;">
				...
				<div style="padding: 48px;">
					<h2 style="font-family: 'DM Serif Display', serif; font-size: 36px; font-weight: 400; color: #fff; margin: 0 0 16px; line-height: 1.15;">
					...
					<a href="/d/community" class="bm-btn-white">
...
<section style="background: #faf9f5; padding: 64px 0;">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 48px; align-items: center;">
			<div>
				<h2 style="font-family: 'DM Serif Display', serif; font-size: clamp(26px, 3.8vw, 38px); line-height: 1.15; color: #2a2018; font-weight: 400; margin: 0 0 16px;">
				...
				<a href="/d/support" class="bm-btn-outline" style="padding: 10px 24px;">
			...
			<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
				{#each [
					...
					<div style="background: #f0ebe3; border-radius: 10px; padding: 24px;">
						<p style="font-family: 'DM Serif Display', serif; font-size: 32px; font-weight: 400; line-height: 1; color: #2a2018; margin: 0;">{stat.value}</p>
...
<section style="background: #faf9f5; padding: 64px 0;">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		<h2 style="font-family: 'DM Serif Display', serif; font-size: clamp(26px, 3.8vw, 38px); line-height: 1.15; color: #2a2018; font-weight: 400; margin: 0 0 40px; text-align: center;">
...
<section style="background: #faf9f5; padding: 64px 0;">
	<div class="mx-auto max-w-[1400px] px-6 lg:px-10">
		<div style="max-width: 800px;">
			<h2 style="font-family: 'DM Serif Display', serif; font-size: clamp(26px, 3.8vw, 38px); line-height: 1.15; color: #2a2018; font-weight: 400; margin: 0 0 32px;">
